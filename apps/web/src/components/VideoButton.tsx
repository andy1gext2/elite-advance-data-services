...
export function VideoButton({
  ...
  // Reports render start/stop so the parent can show a shared progress bar.
  onRenderingChange?: (active: boolean) => void;
  ...
  useEffect(() => onRenderingChange?.(rendering), [rendering, onRenderingChange]);
